...
if (o == null) o = nil;if (c == null) c = nil;
    ...
    Opal.def(self, '$method_added', TMP_Module_method_added_42 = function $$method_added($a_rest) {
      var self = this;

      return nil
    }, TMP_Module_method_added_42.$$arity = -1);
    
    Opal.def(self, '$method_removed', TMP_Module_method_removed_43 = function $$method_removed($a_rest) {
      var self = this;

      return nil
    }, TMP_Module_method_removed_43.$$arity = -1);
    
    Opal.def(self, '$method_undefined', TMP_Module_method_undefined_44 = function $$method_undefined($a_rest) {
      var self = this;

      return nil
    }, TMP_Module_method_undefined_44.$$arity = -1);
    
    Opal.def(self, '$module_eval', TMP_Module_module_eval_45 = function $$module_eval($a_rest) {
    ...
    Opal.def(self, '$module_exec', TMP_Module_module_exec_47 = function $$module_exec($a_rest) {
    ...
    Opal.def(self, '$method_defined?', TMP_Module_method_defined$q_48 = function(method) {
      var self = this;
    ...
    Opal.def(self, '$module_function', TMP_Module_module_function_49 = function $$module_function($a_rest) {
    ...
    Opal.def(self, '$name', TMP_Module_name_50 = function $$name() {
      var self = this;
    ...
    Opal.def(self, '$remove_const', TMP_Module_remove_const_51 = function $$remove_const(name) {
      var self = this;

      return Opal.const_remove(self, name)
    }, TMP_Module_remove_const_51.$$arity = 1);
    
    Opal.def(self, '$to_s', TMP_Module_to_s_52 = function $$to_s() {
      var $a, self = this;
    ...
    Opal.def(self, '$undef_method', TMP_Module_undef_method_53 = function $$undef_method($a_rest) {
      var self = this, names;
    ...
    Opal.def(self, '$instance_variables', TMP_Module_instance_variables_54 = function $$instance_variables() {
    ...
    Opal.def(self, '$dup', TMP_Module_dup_55 = function $$dup() {
    ...
    Opal.def(self, '$copy_class_variables', TMP_Module_copy_class_variables_56 = function $$copy_class_variables(other) {
      var self = this;
    ...
    return (Opal.def(self, '$copy_constants', TMP_Module_copy_constants_57 = function $$copy_constants(other) {
      var self = this;
...
export default function() {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy, $module = Opal.module, $hash2 = Opal.hash2;
  ...
  (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$receiver', TMP_KeyError_receiver_14 = function $$receiver() {
      ...
      return ($truthy($a = self.receiver) ? $a : self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "no receiver is available"))
    }, TMP_KeyError_receiver_14.$$arity = 0);
    return (Opal.def(self, '$key', TMP_KeyError_key_15 = function $$key() {
      var $a, self = this;

      return ($truthy($a = self.key) ? $a : self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "no key is available"))
...
/* Generated by Opal 0.11.0 */
import 'corelib/runtime';
import 'corelib/helpers';
import 'corelib/module';
import 'corelib/class';
import 'corelib/basic_object';
import 'corelib/kernel';
import 'corelib/error';
...
/* Generated by Opal 0.11.0 */
import 'corelib/comparable';
import 'corelib/regexp';
...
export default function() {
  ...
  Opal.add_stubs(['$require', '$include', '$coerce_to?', '$coerce_to', '$raise', '$===', '$format', '$to_s', '$respond_to?', '$to_str', '$<=>', '$==', '$=~', '$new', '$casecmp', '$empty?', '$ljust', '$ceil', '$/', '$+', '$rjust', '$floor', '$to_a', '$each_char', '$to_proc', '$coerce_to!', '$copy_singleton_methods', '$initialize_clone', '$initialize_dup', '$enum_for', '$size', '$chomp', '$[]', '$to_i', '$each_line', '$class', '$match', '$captures', '$proc', '$succ', '$escape']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_String___id___1, TMP_String_try_convert_2, TMP_String_new_3, TMP_String_initialize_4, TMP_String_$_5, TMP_String_$_6, TMP_String_$_7, TMP_String_$lt$eq$gt_8, TMP_String_$eq$eq_9, TMP_String_$eq$_10, TMP_String_$$_11, TMP_String_capitalize_12, TMP_String_casecmp_13, TMP_String_casecmp$q_14, TMP_String_center_15, TMP_String_chars_16, TMP_String_chomp_17, TMP_String_chop_18, TMP_String_chr_19, TMP_String_clone_20, TMP_String_dup_21, TMP_String_count_22, TMP_String_delete_23, TMP_String_delete_prefix_24, TMP_String_delete_suffix_25, TMP_String_downcase_26, TMP_String_each_char_27, TMP_String_each_line_29, TMP_String_empty$q_30, TMP_String_end_with$q_31, TMP_String_gsub_32, TMP_String_hash_33, TMP_String_hex_34, TMP_String_include$q_35, TMP_String_index_36, TMP_String_inspect_37, TMP_String_intern_38, TMP_String_lines_39, TMP_String_length_40, TMP_String_ljust_41, TMP_String_lstrip_42, TMP_String_ascii_only$q_43, TMP_String_match_44, TMP_String_next_45, TMP_String_oct_46, TMP_String_ord_47, TMP_String_partition_48, TMP_String_reverse_49, TMP_String_rindex_50, TMP_String_rjust_51, TMP_String_rpartition_52, TMP_String_rstrip_53, TMP_String_scan_54, TMP_String_split_55, TMP_String_squeeze_56, TMP_String_start_with$q_57, TMP_String_strip_58, TMP_String_sub_59, TMP_String_sum_60, TMP_String_swapcase_61, TMP_String_to_f_62, TMP_String_to_i_63, TMP_String_to_proc_65, TMP_String_to_s_66, TMP_String_tr_67, TMP_String_tr_s_68, TMP_String_upcase_69, TMP_String_upto_70, TMP_String_instance_variables_71, TMP_String__load_72, TMP_String_unpack_73, TMP_String_unpack1_74;
    ...
    Opal.def(self, '$capitalize', TMP_String_capitalize_12 = function $$capitalize() {
      var self = this;

      return self.charAt(0).toUpperCase() + self.substr(1).toLowerCase()
    }, TMP_String_capitalize_12.$$arity = 0);
    
    Opal.def(self, '$casecmp', TMP_String_casecmp_13 = function $$casecmp(other) {
      var self = this;
    ...
    Opal.def(self, '$casecmp?', TMP_String_casecmp$q_14 = function(other) {
      var self = this;
    ...
    }, TMP_String_casecmp$q_14.$$arity = 1);
    
    Opal.def(self, '$center', TMP_String_center_15 = function $$center(width, padstr) {
      var self = this;
    ...
    ;
    }, TMP_String_center_15.$$arity = -2);
    
    Opal.def(self, '$chars', TMP_String_chars_16 = function $$chars() {
      var self = this, $iter = TMP_String_chars_16.$$p, block = $iter || nil;

      if ($iter) TMP_String_chars_16.$$p = null;
    ...
    }, TMP_String_chars_16.$$arity = 0);
    
    Opal.def(self, '$chomp', TMP_String_chomp_17 = function $$chomp(separator) {
      var self = this;
      if ($gvars["/"] == null) $gvars["/"] = nil;
    ...
    ;
      return self;
    }, TMP_String_chomp_17.$$arity = -1);
    
    Opal.def(self, '$chop', TMP_String_chop_18 = function $$chop() {
      var self = this;
    ...
    }, TMP_String_chop_18.$$arity = 0);
    
    Opal.def(self, '$chr', TMP_String_chr_19 = function $$chr() {
      var self = this;

      return self.charAt(0)
    }, TMP_String_chr_19.$$arity = 0);
    
    Opal.def(self, '$clone', TMP_String_clone_20 = function $$clone() {
      var self = this, copy = nil;
      ...
      copy.$initialize_clone(self);
      return copy;
    }, TMP_String_clone_20.$$arity = 0);
    
    Opal.def(self, '$dup', TMP_String_dup_21 = function $$dup() {
      var self = this, copy = nil;
      ...
      copy.$initialize_dup(self);
      return copy;
    }, TMP_String_dup_21.$$arity = 0);
    
    Opal.def(self, '$count', TMP_String_count_22 = function $$count($a_rest) {
      var self = this, sets;
    ...
    }, TMP_String_count_22.$$arity = -1);
    
    Opal.def(self, '$delete', TMP_String_delete_23 = function($a_rest) {
      var self = this, sets;
    ...
    }, TMP_String_delete_23.$$arity = -1);
    
    Opal.def(self, '$delete_prefix', TMP_String_delete_prefix_24 = function $$delete_prefix(prefix) {
      var self = this;

      
      if (!prefix.$$is_string) {
        (prefix = Opal.const_get_relative($nesting, 'Opal').$coerce_to(prefix, Opal.const_get_relative($nesting, 'String'), "to_str"))
      }
    ...
    }, TMP_String_delete_prefix_24.$$arity = 1);
    
    Opal.def(self, '$delete_suffix', TMP_String_delete_suffix_25 = function $$delete_suffix(suffix) {
      var self = this;
    ...
    }, TMP_String_delete_suffix_25.$$arity = 1);
    
    Opal.def(self, '$downcase', TMP_String_downcase_26 = function $$downcase() {
      var self = this;

      return self.toLowerCase()
    }, TMP_String_downcase_26.$$arity = 0);
    
    Opal.def(self, '$each_char', TMP_String_each_char_27 = function $$each_char() {
      var TMP_28, self = this, $iter = TMP_String_each_char_27.$$p, block = $iter || nil;

      if ($iter) TMP_String_each_char_27.$$p = null;
      
      if ((block !== nil)) {
        } else {
        return $send(self, 'enum_for', ["each_char"], (TMP_28 = function(){var self = TMP_28.$$s || this;

        return self.$size()}, TMP_28.$$s = self, TMP_28.$$arity = 0, TMP_28))
      };
    ...
    ;
      return self;
    }, TMP_String_each_char_27.$$arity = 0);
    
    Opal.def(self, '$each_line', TMP_String_each_line_29 = function $$each_line(separator) {
      var self = this, $iter = TMP_String_each_line_29.$$p, block = $iter || nil;
      if ($gvars["/"] == null) $gvars["/"] = nil;

      if (separator == null) {
        separator = $gvars["/"];
      }
      if ($iter) TMP_String_each_line_29.$$p = null;
    ...
    ;
      return self;
    }, TMP_String_each_line_29.$$arity = -1);
    
    Opal.def(self, '$empty?', TMP_String_empty$q_30 = function() {
      var self = this;

      return self.length === 0
    }, TMP_String_empty$q_30.$$arity = 0);
    
    Opal.def(self, '$end_with?', TMP_String_end_with$q_31 = function($a_rest) {
    ...
    ;
      return false;
    }, TMP_String_end_with$q_31.$$arity = -1);
    Opal.alias(self, "eql?", "==");
    Opal.alias(self, "equal?", "===");
    
    Opal.def(self, '$gsub', TMP_String_gsub_32 = function $$gsub(pattern, replacement) {
      var self = this, $iter = TMP_String_gsub_32.$$p, block = $iter || nil;

      if ($iter) TMP_String_gsub_32.$$p = null;
    ...
    }, TMP_String_gsub_32.$$arity = -2);
    
    Opal.def(self, '$hash', TMP_String_hash_33 = function $$hash() {
      var self = this;

      return self.toString()
    }, TMP_String_hash_33.$$arity = 0);
    
    Opal.def(self, '$hex', TMP_String_hex_34 = function $$hex() {
      var self = this;

      return self.$to_i(16)
    }, TMP_String_hex_34.$$arity = 0);
    
    Opal.def(self, '$include?', TMP_String_include$q_35 = function(other) {
      var self = this;
    ...
    }, TMP_String_include$q_35.$$arity = 1);
    
    Opal.def(self, '$index', TMP_String_index_36 = function $$index(search, offset) {
      var self = this;
    ...
    }, TMP_String_index_36.$$arity = -2);
    
    Opal.def(self, '$inspect', TMP_String_inspect_37 = function $$inspect() {
      var self = this;
    ...
    }, TMP_String_inspect_37.$$arity = 0);
    
    Opal.def(self, '$intern', TMP_String_intern_38 = function $$intern() {
      var self = this;

      return self
    }, TMP_String_intern_38.$$arity = 0);
    
    Opal.def(self, '$lines', TMP_String_lines_39 = function $$lines(separator) {
      var self = this, $iter = TMP_String_lines_39.$$p, block = $iter || nil, e = nil;
      if ($gvars["/"] == null) $gvars["/"] = nil;

      if (separator == null) {
        separator = $gvars["/"];
      }
      if ($iter) TMP_String_lines_39.$$p = null;
    ...
    }, TMP_String_lines_39.$$arity = -1);
    
    Opal.def(self, '$length', TMP_String_length_40 = function $$length() {
      var self = this;

      return self.length
    }, TMP_String_length_40.$$arity = 0);
    
    Opal.def(self, '$ljust', TMP_String_ljust_41 = function $$ljust(width, padstr) {
      var self = this;
    ...
    ;
    }, TMP_String_ljust_41.$$arity = -2);
    
    Opal.def(self, '$lstrip', TMP_String_lstrip_42 = function $$lstrip() {
      var self = this;

      return self.replace(/^\s*/, '')
    }, TMP_String_lstrip_42.$$arity = 0);
    
    Opal.def(self, '$ascii_only?', TMP_String_ascii_only$q_43 = function() {
      var self = this;

      return self.match(/[ -~\n]*/)[0] === self
    }, TMP_String_ascii_only$q_43.$$arity = 0);
    
    Opal.def(self, '$match', TMP_String_match_44 = function $$match(pattern, pos) {
      var $a, self = this, $iter = TMP_String_match_44.$$p, block = $iter || nil;

      if ($iter) TMP_String_match_44.$$p = null;
    ...
    }, TMP_String_match_44.$$arity = -2);
    
    Opal.def(self, '$next', TMP_String_next_45 = function $$next() {
      var self = this;
    ...
    }, TMP_String_next_45.$$arity = 0);
    
    Opal.def(self, '$oct', TMP_String_oct_46 = function $$oct() {
      var self = this;
    ...
    }, TMP_String_oct_46.$$arity = 0);
    
    Opal.def(self, '$ord', TMP_String_ord_47 = function $$ord() {
      var self = this;

      return self.charCodeAt(0)
    }, TMP_String_ord_47.$$arity = 0);
    
    Opal.def(self, '$partition', TMP_String_partition_48 = function $$partition(sep) {
      var self = this;
    ...
    }, TMP_String_partition_48.$$arity = 1);
    
    Opal.def(self, '$reverse', TMP_String_reverse_49 = function $$reverse() {
      var self = this;

      return self.split('').reverse().join('')
    }, TMP_String_reverse_49.$$arity = 0);
    
    Opal.def(self, '$rindex', TMP_String_rindex_50 = function $$rindex(search, offset) {
      var self = this;
    ...
    }, TMP_String_rindex_50.$$arity = -2);
    
    Opal.def(self, '$rjust', TMP_String_rjust_51 = function $$rjust(width, padstr) {
      var self = this;
    ...
    ;
    }, TMP_String_rjust_51.$$arity = -2);
    
    Opal.def(self, '$rpartition', TMP_String_rpartition_52 = function $$rpartition(sep) {
      var self = this;
    ...
    }, TMP_String_rpartition_52.$$arity = 1);
    
    Opal.def(self, '$rstrip', TMP_String_rstrip_53 = function $$rstrip() {
      var self = this;

      return self.replace(/[\s\u0000]*$/, '')
    }, TMP_String_rstrip_53.$$arity = 0);
    
    Opal.def(self, '$scan', TMP_String_scan_54 = function $$scan(pattern) {
      var self = this, $iter = TMP_String_scan_54.$$p, block = $iter || nil;

      if ($iter) TMP_String_scan_54.$$p = null;
    ...
    }, TMP_String_scan_54.$$arity = 1);
    Opal.alias(self, "size", "length");
    Opal.alias(self, "slice", "[]");
    
    Opal.def(self, '$split', TMP_String_split_55 = function $$split(pattern, limit) {
      var $a, self = this;
      if ($gvars[";"] == null) $gvars[";"] = nil;
    ...
    }, TMP_String_split_55.$$arity = -1);
    
    Opal.def(self, '$squeeze', TMP_String_squeeze_56 = function $$squeeze($a_rest) {
      var self = this, sets;
    ...
    }, TMP_String_squeeze_56.$$arity = -1);
    
    Opal.def(self, '$start_with?', TMP_String_start_with$q_57 = function($a_rest) {
    ...
    }, TMP_String_start_with$q_57.$$arity = -1);
    
    Opal.def(self, '$strip', TMP_String_strip_58 = function $$strip() {
      var self = this;

      return self.replace(/^\s*/, '').replace(/[\s\u0000]*$/, '')
    }, TMP_String_strip_58.$$arity = 0);
    
    Opal.def(self, '$sub', TMP_String_sub_59 = function $$sub(pattern, replacement) {
      var self = this, $iter = TMP_String_sub_59.$$p, block = $iter || nil;

      if ($iter) TMP_String_sub_59.$$p = null;
    ...
    }, TMP_String_sub_59.$$arity = -2);
    Opal.alias(self, "succ", "next");
    
    Opal.def(self, '$sum', TMP_String_sum_60 = function $$sum(n) {
      var self = this;
    ...
    }, TMP_String_sum_60.$$arity = -1);
    
    Opal.def(self, '$swapcase', TMP_String_swapcase_61 = function $$swapcase() {
      var self = this;
    ...
    }, TMP_String_swapcase_61.$$arity = 0);
    
    Opal.def(self, '$to_f', TMP_String_to_f_62 = function $$to_f() {
      var self = this;
    ...
    }, TMP_String_to_f_62.$$arity = 0);
    
    Opal.def(self, '$to_i', TMP_String_to_i_63 = function $$to_i(base) {
      var self = this;
    ...
    }, TMP_String_to_i_63.$$arity = -1);
    
    Opal.def(self, '$to_proc', TMP_String_to_proc_65 = function $$to_proc() {
      var TMP_64, self = this, sym = nil;

      
      sym = self.valueOf();
      return $send(self, 'proc', [], (TMP_64 = function($a_rest){var self = TMP_64.$$s || this, block, args;

        block = TMP_64.$$p || nil;
        if (block) TMP_64.$$p = null;
        var $args_len = arguments.length, $rest_len = $args_len - 0;
        if ($rest_len < 0) { $rest_len = 0; }
        args = new Array($rest_len);
        for (var $arg_idx = 0; $arg_idx < $args_len; $arg_idx++) {
    ...
    }, TMP_String_to_proc_65.$$arity = 0);
    
    Opal.def(self, '$to_s', TMP_String_to_s_66 = function $$to_s() {
      var self = this;

      return self.toString()
    }, TMP_String_to_s_66.$$arity = 0);
    Opal.alias(self, "to_str", "to_s");
    Opal.alias(self, "to_sym", "intern");
    
    Opal.def(self, '$tr', TMP_String_tr_67 = function $$tr(from, to) {
      var self = this;
      ...
      return new_str;
    ;
    }, TMP_String_tr_67.$$arity = 2);
    
    Opal.def(self, '$tr_s', TMP_String_tr_s_68 = function $$tr_s(from, to) {
      var self = this;
      ...
      return new_str;
    ;
    }, TMP_String_tr_s_68.$$arity = 2);
    
    Opal.def(self, '$upcase', TMP_String_upcase_69 = function $$upcase() {
      var self = this;

      return self.toUpperCase()
    }, TMP_String_upcase_69.$$arity = 0);
    
    Opal.def(self, '$upto', TMP_String_upto_70 = function $$upto(stop, excl) {
      var self = this, $iter = TMP_String_upto_70.$$p, block = $iter || nil;

      if (excl == null) {
        excl = false;
      }
      if ($iter) TMP_String_upto_70.$$p = null;
  ...
  ;
    ...
    Opal.def(self, '$instance_variables', TMP_String_instance_variables_71 = function $$instance_variables() {
      var self = this;

      return []
    }, TMP_String_instance_variables_71.$$arity = 0);
    Opal.defs(self, '$_load', TMP_String__load_72 = function $$_load($a_rest) {
      var self = this, args;
      ...
      return $send(self, 'new', Opal.to_a(args))
    }, TMP_String__load_72.$$arity = -1);
    
    Opal.def(self, '$unpack', TMP_String_unpack_73 = function $$unpack(format) {
      var self = this;

      return self.$raise("To use String#unpack, you must first require 'corelib/string/unpack'.")
    }, TMP_String_unpack_73.$$arity = 1);
    return (Opal.def(self, '$unpack1', TMP_String_unpack1_74 = function $$unpack1(format) {
      var self = this;

      return self.$raise("To use String#unpack1, you must first require 'corelib/string/unpack'.")
    }, TMP_String_unpack1_74.$$arity = 1), nil) && 'unpack1';
...
export default function() {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send, $falsy = Opal.falsy, $hash2 = Opal.hash2;

  Opal.add_stubs(['$each', '$public_send', '$destructure', '$to_enum', '$enumerator_size', '$new', '$yield', '$raise', '$slice_when', '$!', '$enum_for', '$flatten', '$map', '$warn', '$proc', '$==', '$nil?', '$respond_to?', '$coerce_to!', '$>', '$*', '$coerce_to', '$try_convert', '$<', '$+', '$-', '$ceil', '$/', '$size', '$__send__', '$length', '$<=', '$[]', '$push', '$<<', '$[]=', '$===', '$inspect', '$<=>', '$first', '$reverse', '$sort', '$to_proc', '$compare', '$call', '$dup', '$to_a', '$lambda', '$sort!', '$map!', '$has_key?', '$values', '$zip']);
  return (function($base, $parent_nesting) {
  ...
  ;
    ...
    Opal.def(self, '$all?', TMP_Enumerable_all$q_1 = function(pattern) {try {
      ...
      if ($truthy(pattern !== undefined)) {
        $send(self, 'each', [], (TMP_2 = function($a_rest){var self = TMP_2.$$s || this, value;
          ...
          if ($truthy($send(pattern, 'public_send', ["==="].concat(Opal.to_a(value))))) {
            return nil
            } else {
            Opal.ret(false)
    ...
    Opal.def(self, '$chunk', TMP_Enumerable_chunk_9 = function $$chunk() {
      ...
      return $send(Opal.const_get_qualified('::', 'Enumerator'), 'new', [], (TMP_11 = function(yielder){var self = TMP_11.$$s || this;
...
if (item == null) item = nil;
    ...
    ;
      if ($truthy(object != null)) {
        ...
        return Opal.const_get_relative($nesting, 'Opal').$destructure(args)['$=='](object)}, TMP_20.$$s = self, TMP_20.$$arity = -1, TMP_20))
...
if (value == null) value = nil;
    ...
    Opal.def(self, '$lazy', TMP_Enumerable_lazy_58 = function $$lazy() {
      ...
      return $send(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Enumerator'), 'Lazy'), 'new', [self, self.$enumerator_size()], (TMP_57 = function(enum$, $a_rest){var self = TMP_57.$$s || this, args;
...
if (a == null) a = nil;if (b == null) b = nil;
    ...
    Opal.def(self, '$none?', TMP_Enumerable_none$q_69 = function(pattern) {try {
      ...
      if ($truthy(pattern !== undefined)) {
        ...
        $send(self, 'each', [], (TMP_72 = function($a_rest){var self = TMP_72.$$s || this, value, item = nil;
          ...
          item = Opal.const_get_relative($nesting, 'Opal').$destructure(value);
          if ($truthy(item)) {
            Opal.ret(false)
            } else {
            return nil
    ...
    Opal.def(self, '$one?', TMP_Enumerable_one$q_73 = function(pattern) {try {
      ...
      count = 0;
      if ($truthy(pattern !== undefined)) {
        $send(self, 'each', [], (TMP_74 = function($a_rest){var self = TMP_74.$$s || this, value;
    ...
    Opal.def(self, '$slice_before', TMP_Enumerable_slice_before_83 = function $$slice_before(pattern) {
      ...
      return $send(Opal.const_get_relative($nesting, 'Enumerator'), 'new', [], (TMP_84 = function(e){var self = TMP_84.$$s || this;
if (e == null) e = nil;
...
if (e == null) e = nil;
      ...
      return $send(Opal.const_get_relative($nesting, 'Enumerator'), 'new', [], (TMP_87 = function(yielder){var self = TMP_87.$$s || this;
if (yielder == null) yielder = nil;
    ...
    Opal.def(self, '$slice_when', TMP_Enumerable_slice_when_88 = function $$slice_when() {
      ...
      return $send(Opal.const_get_relative($nesting, 'Enumerator'), 'new', [], (TMP_89 = function(yielder){var self = TMP_89.$$s || this;
if (yielder == null) yielder = nil;
    ...
    Opal.def(self, '$sort', TMP_Enumerable_sort_90 = function $$sort() {
      ...
      if ((block !== nil)) {
        ...
        block = $send(self, 'lambda', [], (TMP_91 = function(a, b){var self = TMP_91.$$s || this;
if (a == null) a = nil;if (b == null) b = nil;
...
if (i == null) i = nil;
    ...
    Opal.def(self, '$sum', TMP_Enumerable_sum_97 = function $$sum(initial) {
      var TMP_98, self = this, $iter = TMP_Enumerable_sum_97.$$p, block = $iter || nil, result = nil;
      ...
      result = initial;
      $send(self, 'each', [], (TMP_98 = function($a_rest){var self = TMP_98.$$s || this, args, item = nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$__coerced__', TMP_Numeric___coerced___2 = function $$__coerced__(method, other) {
      ...
      if ($truthy(other['$respond_to?']("coerce"))) {
        ...
        if ("+"['$===']($case) || "-"['$===']($case) || "*"['$===']($case) || "/"['$===']($case) || "%"['$===']($case) || "&"['$===']($case) || "|"['$===']($case) || "^"['$===']($case) || "**"['$===']($case)) {return self.$raise(Opal.const_get_relative($nesting, 'TypeError'), "" + (other.$class()) + " can't be coerced into Numeric")}
        else if (">"['$===']($case) || ">="['$===']($case) || "<"['$===']($case) || "<="['$===']($case) || "<=>"['$===']($case)) {return self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "comparison of " + (self.$class()) + " with " + (other.$class()) + " failed")}
        else { return nil }})()
      }
...
export default function() {
  ...
  Opal.add_stubs(['$require', '$include', '$to_a', '$warn', '$raise', '$replace', '$respond_to?', '$to_ary', '$coerce_to', '$coerce_to?', '$===', '$join', '$to_str', '$class', '$hash', '$<=>', '$==', '$object_id', '$inspect', '$enum_for', '$bsearch_index', '$to_proc', '$coerce_to!', '$>', '$*', '$enumerator_size', '$empty?', '$size', '$map', '$equal?', '$dup', '$each', '$[]', '$dig', '$eql?', '$length', '$begin', '$end', '$exclude_end?', '$flatten', '$__id__', '$to_s', '$new', '$max', '$min', '$!', '$>=', '$**', '$delete_if', '$reverse', '$rotate', '$rand', '$at', '$keep_if', '$shuffle!', '$<', '$sort', '$sort_by', '$!=', '$times', '$[]=', '$-', '$<<', '$values', '$kind_of?', '$last', '$first', '$upto', '$reject', '$pristine', '$singleton_class']);
    ...
    Opal.def(self, '$flatten', TMP_Array_flatten_53 = function $$flatten(level) {
      ...
      function _flatten(array, level) {
        ...
        for (i = 0, length = array.length; i < length; i++) {
          ...
          if (!Opal.const_get_relative($nesting, 'Opal')['$respond_to?'](item, "to_ary", true)) {
            result.push(item);
            continue;
          }
...
if (ivar == null) ivar = nil;
    ...
    Opal.const_get_relative($nesting, 'Opal').$pristine(self.$singleton_class(), "allocate");
    Opal.const_get_relative($nesting, 'Opal').$pristine(self, "copy_instance_variables", "initialize_dup");
...
export default function() {
  ...
  Opal.add_stubs(['$require', '$include', '$coerce_to?', '$[]', '$merge!', '$allocate', '$raise', '$coerce_to!', '$each', '$fetch', '$>=', '$>', '$==', '$compare_by_identity', '$lambda?', '$abs', '$arity', '$call', '$enum_for', '$size', '$respond_to?', '$class', '$dig', '$new', '$inspect', '$map', '$to_proc', '$flatten', '$eql?', '$default', '$dup', '$default_proc', '$default_proc=', '$-', '$default=', '$alias_method', '$proc']);
...
if (other_key == null) other_key = nil;if (other_val == null) other_val = nil;
    ...
    ;
      return self.$raise(Opal.const_get_relative($nesting, 'KeyError').$new("" + "key not found: " + (key.$inspect()), $hash2(["key", "receiver"], {"key": key, "receiver": self})));
...
export default function() {
  ...
  Opal.add_stubs(['$require', '$bridge', '$raise', '$name', '$class', '$Float', '$respond_to?', '$coerce_to!', '$__coerced__', '$===', '$!', '$>', '$**', '$new', '$<', '$to_f', '$==', '$nan?', '$infinite?', '$enum_for', '$+', '$-', '$gcd', '$lcm', '$%', '$/', '$frexp', '$to_i', '$ldexp', '$rationalize', '$*', '$<<', '$to_r', '$truncate', '$-@', '$size', '$<=', '$>=', '$<=>', '$compare', '$empty?']);
  ...
  ;
    ...
    Opal.def(self, '$allbits?', TMP_Number_allbits$q_28 = function(mask) {
      ...
      mask = Opal.const_get_relative($nesting, 'Opal')['$coerce_to!'](mask, Opal.const_get_relative($nesting, 'Integer'), "to_int");
    ...
    Opal.def(self, '$pow', TMP_Number_pow_52 = function $$pow(b, m) {
      ...
      if (m === undefined) {
        ...
        if (!(Opal.const_get_relative($nesting, 'Integer')['$==='](b))) {
          self.$raise(Opal.const_get_relative($nesting, 'TypeError'), "Integer#pow() 2nd argument not allowed unless a 1st argument is integer")
        }

        if (b < 0) {
          self.$raise(Opal.const_get_relative($nesting, 'TypeError'), "Integer#pow() 1st argument cannot be negative when 2nd argument specified")
        }

        if (!(Opal.const_get_relative($nesting, 'Integer')['$==='](m))) {
          self.$raise(Opal.const_get_relative($nesting, 'TypeError'), "Integer#pow() 2nd argument not allowed unless all arguments are integers")
        }
    ...
    Opal.def(self, '$step', TMP_Number_step_58 = function $$step($limit, $step, $kwargs) {
      ...
      function validateParameters() {
        ...
        if (sign === nil) {
          self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "0 can't be coerced into " + (step.$class()))
        }
    ...
    Opal.def(self, '$digits', TMP_Number_digits_67 = function $$digits(base) {
      ...
      if ($rb_lt(self, 0)) {
        self.$raise(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Math'), 'DomainError'), "out of domain")};
      base = Opal.const_get_relative($nesting, 'Opal')['$coerce_to!'](base, Opal.const_get_relative($nesting, 'Integer'), "to_int");
  ...
  (function($base, $super, $parent_nesting) {
    ...
    (function(self, $parent_nesting) {
      ...
      return (Opal.def(self, '$sqrt', TMP_sqrt_80 = function $$sqrt(n) {
        ...
        if (n < 0) {
          self.$raise(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Math'), 'DomainError'), "Numerical argument is out of domain - \"isqrt\"")
        }
...
import 'opal/base';
import 'corelib/nil';
import 'corelib/boolean';
import 'corelib/string';
import 'corelib/comparable';
import 'corelib/enumerable';
import 'corelib/enumerator';
import 'corelib/array';
import 'corelib/hash';
import 'corelib/number';
import 'corelib/range';
import 'corelib/proc';
import 'corelib/method';
import 'corelib/regexp';
import 'corelib/variables';
import 'opal/regexp_anchors';
...
if (name == null) name = nil;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.def(self, '$encoding', TMP_String_encoding_31 = function $$encoding() {
      var self = this;

      return self.encoding
    }, TMP_String_encoding_31.$$arity = 0);
    
    Opal.def(self, '$force_encoding', TMP_String_force_encoding_32 = function $$force_encoding(encoding) {
      var self = this;
    ...
    Opal.def(self, '$getbyte', TMP_String_getbyte_33 = function $$getbyte(idx) {
      var self = this;

      return self.encoding.$getbyte(self, idx)
    }, TMP_String_getbyte_33.$$arity = 1);
    return (Opal.def(self, '$valid_encoding?', TMP_String_valid_encoding$q_34 = function() {
      var self = this;
...
export default function() {
  ...
  Opal.add_stubs(['$require', '$===', '$real?', '$raise', '$new', '$*', '$cos', '$sin', '$attr_reader', '$class', '$==', '$real', '$imag', '$Complex', '$-@', '$+', '$__coerced__', '$-', '$nan?', '$/', '$conj', '$abs2', '$quo', '$polar', '$exp', '$log', '$>', '$!=', '$divmod', '$**', '$hypot', '$atan2', '$lcm', '$denominator', '$finite?', '$infinite?', '$to_s', '$numerator', '$abs', '$arg', '$rationalize', '$to_f', '$to_i', '$to_r', '$inspect', '$positive?', '$zero?']);
    ...
    Opal.def(self, '$initialize', TMP_Struct_initialize_14 = function $$initialize($a_rest) {
      ...
      if ($truthy(self.$class().$$keyword_init)) {
        ...
        if ($truthy(($truthy($b = $rb_gt(args.$length(), 1)) ? $b : (args.length === 1 && !kwargs.$$is_hash)))) {
          self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "wrong number of arguments (given " + (args.$length()) + ", expected 0)")};
        extra = $rb_minus(kwargs.$keys(), self.$class().$members());
        if ($truthy($rb_gt(extra.$length(), 0))) {
          self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "" + "unknown keywords: " + (extra.$join(", ")))};
...
if (name == null) name = nil;if (value == null) value = nil;
    ...
    Opal.def(self, '$to_h', TMP_Struct_to_h_33 = function $$to_h() {
      ...
      return $send(self.$class().$members(), 'inject', [$hash2([], {})], (TMP_32 = function(h, name){var self = TMP_32.$$s || this, $writer = nil;
if (h == null) h = nil;if (name == null) name = nil;
        ...
        $writer[$rb_minus($writer["length"], 1)];;
        return h;}, TMP_32.$$s = self, TMP_32.$$arity = 2, TMP_32))
...
if (file == null) file = nil;
      ...
      Opal.def(self, '$join', TMP_join_11 = function $$join($a_rest) {
...
if (item == null) item = nil;if (index == null) index = nil;
      ...
      return (Opal.def(self, '$split', TMP_split_12 = function $$split(path) {
        var self = this;
...
/* Generated by Opal 0.11.0 */
import 'corelib/random/seedrandom.js';
...
export default function() {
  ...
  Opal.add_stubs(['$require', '$attr_reader', '$coerce_to!', '$reseed', '$new_seed', '$rand', '$seed', '$<', '$raise', '$force_encoding', '$join', '$map', '$times', '$chr', '$new', '$===', '$==', '$state', '$encode']);
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    Opal.defs(self, '$urandom', TMP_Random_urandom_7 = function $$urandom(size) {
      ...
      if ($truthy($rb_lt(size, 0))) {
        self.$raise(Opal.const_get_relative($nesting, 'ArgumentError'), "negative string size (or size too big)")};
      return $send(size.$times(), 'map', [], (TMP_6 = function(){var self = TMP_6.$$s || this;

      return self.$rand(255).$chr()}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6)).$join().$force_encoding("ASCII-8BIT");
    ...
    Opal.def(self, '$bytes', TMP_Random_bytes_10 = function $$bytes(length) {
      ...
      length = Opal.const_get_relative($nesting, 'Opal')['$coerce_to!'](length, Opal.const_get_relative($nesting, 'Integer'), "to_int");
      return $send(length.$times(), 'map', [], (TMP_9 = function(){var self = TMP_9.$$s || this;

      return self.$rand(255).$chr()}, TMP_9.$$s = self, TMP_9.$$arity = 0, TMP_9)).$join().$encode(Opal.const_get_qualified(Opal.const_get_relative($nesting, 'Encoding'), 'ASCII_8BIT'));
...
export default function() {
  ...
  var TMP_public_31, TMP_private_32, self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $module = Opal.module;
...
;
  (function($base, $super, $parent_nesting) {
    ...
    return (Opal.def(self, '$prepend', TMP_String_prepend_19 = function $$prepend($a_rest) {
      ...
      return self.$raise(Opal.const_get_relative($nesting, 'NotImplementedError'), (ERROR)['$%']("prepend"))
...
import 'opal/base';
import 'opal/mini';
import 'corelib/string/inheritance';
import 'corelib/string/encoding';
import 'corelib/math';
import 'corelib/complex';
import 'corelib/rational';
import 'corelib/time';
import 'corelib/struct';
import 'corelib/io';
import 'corelib/main';
import 'corelib/dir';
import 'corelib/file';
import 'corelib/process';
import 'corelib/random';
import 'corelib/unsupported';
...
export default function() {
  ...
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"browser\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"browser/delay\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyperloop-config\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
    Opal.modules["hyperloop/autoloader"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyperloop/autoloader\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
    Opal.modules["hyperloop/autoloader_starter"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyperloop/autoloader_starter\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"reactrb/auto-import\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyper-component\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyper-react\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyper-model\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyper-store\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyper-operation\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
  ...
  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyper-router\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
export default function() {
    Opal.modules["hyperloop_webpack_loader"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$raise']);
  return self.$raise(Opal.const_get_relative($nesting, 'LoadError'), "can't find file: \"hyperloop_webpack_loader\" in:\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/opal\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/stdlib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/opal-0.11.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/ast-2.4.0/lib\n- /Users/jan/.rvm/gems/ruby-2.5.1/gems/parser-2.4.0.2/lib\n\nWith the following extensions:\n- .js\n- .js.js\n- .rb\n- .js.rb\n- .opal\n- .js.opal\n- .opalerb\n- .js.opalerb\n- .erb\n- .js.erb\n\nAnd the following processors:\n- Opal::BuilderProcessors::JsProcessor\n- Opal::BuilderProcessors::RubyProcessor\n- Opal::BuilderProcessors::OpalERBProcessor\n- Opal::BuilderProcessors::ERBProcessor\n")
    };
...
import 'opal';
import 'browser';
import 'browser/delay';
import 'hyperloop-config';
import 'hyperloop/autoloader';
import 'hyperloop/autoloader_starter';
import 'reactrb/auto-import';
import 'hyper-component';
import 'hyper-react';
import 'hyper-model';
import 'hyper-store';
import 'hyper-operation';
import 'hyper-router';
import 'hyperloop_webpack_loader';

export default function() {
    Opal.modules["ruby"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;

  Opal.add_stubs(['$require', '$puts', '$require_tree']);
  
  self.$require("opal");
  self.$require("browser");
  self.$require("browser/delay");
  self.$require("hyperloop-config");
  self.$require("hyperloop/autoloader");
  self.$require("hyperloop/autoloader_starter");
  ...
  self.$require("hyperloop_webpack_loader");
  self.$puts("Loaded!");
  self.$require_tree("ruby_tree");
  return self.$puts("after require tree");
    };
...
export default function() {
    Opal.modules["(exit)"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice;
